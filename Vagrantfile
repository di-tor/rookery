...
mysql_root_password   = "dev"   # We'll assume user "root"
...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "Rookery" do |vapro|
  end
...
#   end
  ...
  config.vm.provision "shell", path: "#{github_url}/scripts/base.sh", args: [github_url, server_swap, server_timezone], privileged: true
...
#   config.vm.provision "shell", path: "#{github_url}/scripts/vim.sh", args: github_url
  ...
  config.vm.provision "shell", path: "./vagrant-scripts/nginx.sh", args: [server_ip, public_folder, hostname, github_url], privileged: true
  ...
  config.vm.provision "shell", path: "./vagrant-scripts/mysql.sh", args: [mysql_root_password, mysql_version, mysql_enable_remote]
...
#   config.vm.provision "shell", path: "#{github_url}/scripts/nodejs.sh", privileged: false, args: nodejs_packages.unshift(nodejs_version, github_url)
  ...
  config.vm.provision "shell", path: "./vagrant-scripts/composer.sh", privileged: false
  ...
  ##########
  config.vm.provision "shell", path: "./vagrant-scripts/environment.sh", privileged: false, args: [mysql_root_password]
